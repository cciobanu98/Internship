...
namespace ClassExemple
{
    ...
    public abstract class User : EventArgs
    {
    ...
    class Program
    {
        ...
        static void ToMail(object sender, User u)
        {
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine($"Send Email of Login {u.Name}");
            Console.ResetColor();
        }
        ...
        static void Main(string[] args)
        {
            ...
            WeakEventManager<Logger<User>, User>.AddHandler(logger, "MessageToSent", ToMail);
            ...
            WeakEventManager<Logger<User>, User>.RemoveHandler(logger, "MessageToSent", ToMail);
            logger.LoginUser(lst[2]);
            lst.Remove(lst[0]);
